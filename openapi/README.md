...
- API version: 1.0.0
- Build date: 2022-06-02T18:24:48.464441700+10:00[Australia/Sydney]
...
```
cargo run --example client AddComment
cargo run --example client GetComment
```
...
------------- | ------------- | -------------
[**addComment**](docs/comment_api.md#addComment) | **POST** /comment | Add a new comment to the podcast
[**getComment**](docs/comment_api.md#getComment) | **GET** /comment | Get all comments
