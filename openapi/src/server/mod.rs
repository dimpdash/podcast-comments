...
mod paths {
    ...
    lazy_static! {
        pub static ref REGEX_PET_PETID_UPLOADIMAGE: regex::Regex =
            regex::Regex::new(r"^/pet/(?P<petId>[^/?#]*)/uploadImage$")
    ...
    lazy_static! {
        pub static ref REGEX_STORE_ORDER_ORDERID: regex::Regex =
            regex::Regex::new(r"^/store/order/(?P<orderId>[^/?#]*)$")
    ...
    lazy_static! {
        pub static ref REGEX_USER_USERNAME: regex::Regex =
            regex::Regex::new(r"^/user/(?P<username>[^/?#]*)$")
